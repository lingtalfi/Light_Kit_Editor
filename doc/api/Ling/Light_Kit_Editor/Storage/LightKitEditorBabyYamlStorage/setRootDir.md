...
LightKitEditorBabyYamlStorage::setRootDir
================



LightKitEditorBabyYamlStorage::setRootDir — Sets the rootDir.
...
public [LightKitEditorBabyYamlStorage::setRootDir](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/doc/api/Ling/Light_Kit_Editor/Storage/LightKitEditorBabyYamlStorage/setRootDir.md)(string $rootDir) : void
...
Previous method: [__construct](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/doc/api/Ling/Light_Kit_Editor/Storage/LightKitEditorBabyYamlStorage/__construct.md)<br>Next method: [addPage](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/doc/api/Ling/Light_Kit_Editor/Storage/LightKitEditorBabyYamlStorage/addPage.md)<br>
